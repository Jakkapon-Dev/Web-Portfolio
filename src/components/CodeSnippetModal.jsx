    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-slate-950/80 backdrop-blur-md">
        ...
        <motion.div
          ...
          className="relative w-full max-w-5xl max-h-[92vh] flex flex-col bg-[#0F141C] text-slate-100 rounded-3xl border border-slate-800 shadow-2xl z-10 overflow-hidden text-left"
        >
          {/* Header */}
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 sm:p-6 border-b border-slate-800/80 bg-[#161D28]/80">
            <div>
          ...
          {/* Description & Callout */}
          <div className="px-6 py-3 bg-[#111722] border-b border-slate-800/80 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
            ...
            <button
              onClick={handleCopy}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-mono-code font-semibold transition-all shrink-0 self-start sm:self-auto border border-slate-700/60"
            >
              {copied ? (
                <>
          ...
          {/* Footer Info */}
          <div className="p-4 bg-[#111722] border-t border-slate-800 flex items-center justify-between text-[11px] font-mono-code text-slate-400">
            <div className="flex items-center gap-2">
            ...
            <button
              onClick={onClose}
              className="px-4 py-1.5 rounded-lg bg-cobalt-500 hover:bg-cobalt-600 text-white font-semibold transition-colors"
            >
