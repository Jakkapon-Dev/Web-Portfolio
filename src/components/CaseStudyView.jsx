...
export default function CaseStudyView({ projectId, onClose, onSelectProject }) {
  ...
  const theme = projectConfig?.theme || {
    accent: '#2A63F0',
    btnPrimary: 'bg-cobalt-500 hover:bg-cobalt-400 text-white',
  ...
  return (
    <motion.div
      ...
      className="w-full min-h-screen bg-[#F7F9FC] dark:bg-[#0F141C] text-slate-900 dark:text-slate-100 py-6 px-4 sm:px-8 lg:px-12 xl:px-16 font-sans selection:bg-cobalt-500 selection:text-white text-left"
    >
      <div className="w-full max-w-[1560px] mx-auto space-y-8">
        ...
        {/* ======================================================== */}
        <header className="sticky top-4 z-40 w-full flex flex-wrap items-center justify-between gap-3 py-3 px-5 sm:px-6 rounded-2xl bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-slate-200 dark:border-slate-800 shadow-lg">
          ...
          <div className="flex items-center gap-3">
            <button
              ref={backBtnRef}
              onClick={onClose}
              className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-cobalt-500 hover:text-white text-slate-700 dark:text-slate-300 transition-all flex items-center gap-1.5 text-xs font-mono-code font-bold shadow-sm"
            >
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              onClick={onClose}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-cobalt-500/10 hover:text-cobalt-500 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 text-xs font-mono-code font-bold transition-all ml-1"
            >
              <span>Close</span>
        ...
        <section className="p-8 sm:p-12 lg:p-14 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4 pb-4 border-b border-slate-100 dark:border-slate-800">
            <div className="shrink-0">
              <JakkBotMascot projectId={study.id} expression="intro" lang={lang} />
            </div>
            <div className="space-y-1 pb-0 sm:pb-2">
              <p className="text-[11px] font-mono-code text-slate-500 dark:text-slate-400 uppercase tracking-widest">JAKK-BOT is narrating this story</p>
              <p className="text-xs font-mono-code text-slate-400 dark:text-slate-500">Follow along through each part below</p>
            </div>
          </div>
          
          <div className="flex flex-wrap items-center gap-2">
            <span className={`px-3.5 py-1 rounded-full text-xs font-mono-code font-bold ${theme.badgeClass || 'bg-cobalt-500/10 border border-cobalt-500/30 text-cobalt-600 dark:text-cobalt-400'}`}>
              PROJECT STORY #{study.number}
            </span>
            <span className="px-3.5 py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-xs font-mono-code text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
              {study.category}
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6 pt-4 border-t border-slate-100 dark:border-slate-800 text-xs font-mono-code text-slate-500 dark:text-slate-400">
            <div className="flex items-center gap-2">
              <span className="w-6 h-6 rounded-full bg-cobalt-500 text-white font-bold flex items-center justify-center text-[10px]">
                JW
              </span>
              <span className="font-bold text-slate-800 dark:text-slate-200">Jakkapon Wapakpet</span>
            </div>
            <div className="flex items-center gap-1.5">
            ...
            {study.github && (
              <a
                ...
                className="ml-auto inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-cobalt-500 hover:text-white text-slate-700 dark:text-slate-300 transition-all font-bold"
              >
        ...
        <div className="w-full space-y-12">
          ...
          {/* ---------------------------------------------------- */}
          <section id="sec-problem" className="p-8 sm:p-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl space-y-8">
            {/* Mascot row */}
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3 sm:gap-5 pb-2">
              ...
              <div className="space-y-1 pb-4 border-b border-slate-100 dark:border-slate-800 flex-1 w-full">
                ...
                <h2 className="text-xl sm:text-2xl md:text-4xl font-extrabold text-slate-900 dark:text-white">
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {study.chapter1.principles.map((p) => (
                  <div
                    key={p.num}
                    className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/80 space-y-3 flex flex-col justify-between"
                  >
                    <div className="font-bold text-sm sm:text-base text-slate-900 dark:text-white font-mono-code flex items-center gap-2.5">
                      <span className="w-7 h-7 rounded-xl bg-cobalt-500/20 text-cobalt-500 flex items-center justify-center text-xs font-bold shrink-0">
                        {p.num}
                      </span>
          ...
          {/* ---------------------------------------------------- */}
          <section id="sec-architecture" className="p-8 sm:p-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3 sm:gap-5">
              ...
              <div className="space-y-1 pb-4 border-b border-slate-100 dark:border-slate-800 flex-1 w-full">
                ...
                <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-mono-code">
          ...
          {/* ---------------------------------------------------- */}
          {study.methodology && (
            <section id="sec-methodology" className="p-8 sm:p-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl space-y-8">
              <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3 sm:gap-5">
                <div className="shrink-0">
                  <JakkBotMascot projectId={study.id} expression="architecture" lang={lang} />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {study.methodology.steps.map((step, idx) => (
                  ...
                  >
                    <div>
                      <span
                        className="px-2.5 py-0.5 rounded-md text-[10px] font-mono-code font-bold inline-block mb-2 border"
                        style={{
                      ...
                      <h4 className="font-bold text-sm sm:text-base text-slate-900 dark:text-white font-mono-code mb-2">
          ...
          {/* ---------------------------------------------------- */}
          {study.warStory && (
            <section id="sec-warstory" className="p-8 sm:p-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3 sm:gap-5">
                <div className="shrink-0">
          ...
          {/* ---------------------------------------------------- */}
          <section id="sec-decisions" className="p-8 sm:p-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3 sm:gap-5">
              <div className="shrink-0">
                <JakkBotMascot projectId={study.id} expression="decision" lang={lang} />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {study.chapter2.tradeoffs.map((item, idx) => (
                <div
                  key={idx}
                  className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/80 space-y-3 hover:border-cobalt-500/50 transition-colors"
                >
                  <div className="text-xs sm:text-sm font-mono-code font-bold text-cobalt-600 dark:text-cobalt-400 flex items-center gap-1.5">
          ...
          {/* ---------------------------------------------------- */}
          <section id="sec-results" className="p-8 sm:p-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl space-y-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3 sm:gap-5">
              <div className="shrink-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {study.chapter3.metrics.map((m, idx) => (
                <div key={idx} className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/80 text-center space-y-2">
                  <div className="text-3xl sm:text-5xl font-extrabold font-mono-code" style={{ color: theme.accent }}>
                    {m.val}
                  </div>
                  <div className="text-xs sm:text-sm font-mono-code text-slate-500 dark:text-slate-400 font-semibold">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4 border-t border-slate-100 dark:border-slate-800">
              {study.github && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`inline-flex items-center gap-2 px-6 py-3.5 rounded-xl font-bold text-xs sm:text-sm shadow-md transition-all font-mono-code ${theme.btnPrimary || 'bg-cobalt-500 hover:bg-cobalt-400 text-white shadow-cobalt-500/20'}`}
                >
              ...
              <button
                onClick={onClose}
                className="px-6 py-3.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-semibold text-xs sm:text-sm transition-all border border-slate-200 dark:border-slate-700 font-mono-code"
              >
